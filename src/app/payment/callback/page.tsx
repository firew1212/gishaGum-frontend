  ...
  useEffect(() => {
    ...
    async function verify() {
      ...
      try {
         ...
         *
         * A payment is successful only when the backend
         * confirms that the payment is PAID.
         */
        if (
            ...
            {result?.booking && (
              <div className="payment-result-summary">
                ...
                <div className="payment-summary-row">
                  ...
                  <strong>
                    {formatStatus(result.booking.status)}
                  </strong>
                </div>
                ...
                {result.payment?.gatewayReference && (
                  <div className="payment-summary-row">
      ...
      <section className="payment-result-page">
        <div className="container">
          <div className="payment-result-card">
            ...
            <p>
              The payment provider has not returned a
              final payment status yet. Please check
              your booking again shortly.
            </p>
